...
const DecoratorBlob1 = styled(SvgDecoratorBlob1)`
  ${tw`pointer-events-none opacity-50 absolute left-0 bottom-0 h-64 w-64 transform -translate-x-4`}
`;
    ...
    <>
      ...
      <Container>
        <TwoColumn>
          <LeftColumn>
            <Heading>
              Beautiful React Templates <span tw="text-blue-500">for you.</span>
            </Heading>
            <Paragraph>
